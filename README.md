...
6. Acess the demo app Swagger UI via: [http://localhost:8082/q/swagger-ui/](http://localhost:8082/q/swagger-ui/)

7. Access the demo UI in browser via: [http://localhost:8082](http://localhost:8082)
